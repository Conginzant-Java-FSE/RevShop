...
@WebMvcTest(controllers = { ProductController.class,
                GlobalExceptionHandler.class }, excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = JwtAuthenticationFilter.class))
...
class ProductControllerTest {
        ...
        void filterProducts_shouldReturn200_withFilteredProductPage() throws Exception {
                Page<ProductDTO> productPage = new PageImpl<>(List.of(sampleDTO));
                when(productService.filterProducts(isNull(), eq(3000.0), eq(5000.0), eq(1L), any(Pageable.class)))
